...
export default function DfProcess() {
    return (
        <div className="projectGrid">
            ...
            <div className="hero-image" id="df-3">
  
            </div>

            <div className="hero-image" id="df-4">
 
            </div>

            <div className="hero-image" id="df-5">
                
            </div>

            <div className="hero-image" id="df-6">
                
            </div>

            <div className="hero-image" id="df-7">

            </div>

            <div className="hero-image" id="df-8">

            </div>

            <div className="hero-image" id="df-9">

            </div>

            <div className="hero-image" id="df-10">
