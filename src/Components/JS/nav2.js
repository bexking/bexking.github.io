...
export default function Nav() {
    ...
    const links = <>
        <Link onClick={() => setBurger(!showBurger)} to="/work" id="nav-places" className='nav-link'>Work</Link>
        <Link onClick={() => setBurger(!showBurger)} to="/about" id="nav-places" className='nav-link'>About</Link>
        <Link onClick={() => setBurger(!showBurger)} to="/contact" id="nav-places" className='nav-link'>Contact</Link>
    </>;
