        ...
        <div className="project-page">           
            <div className='project-heading-container'>
                <div className="text-block-third">
                    ...
                    <h1 className='long-project-title'>Developing eligibility criteria for principal appointment</h1>
            ...
            <div className='body-copy'>
                <p>
                    For this work I helped develop and deliver a consultation to test new Principal Eligibility Criteria to be used when appointing principals in Aotearoa. Following the Tomorrow’s Schools review, the Ministry of Education were required to develop eligibility criteria for principal appointment. The only existing standard requirements were holding a Teachers Practising Certificate (not a full teaching certificate).
                </p>
                <p>
